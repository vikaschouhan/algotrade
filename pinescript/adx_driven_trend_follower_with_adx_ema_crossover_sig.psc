//@version=4
strategy("ADX driven trend follower with ADX EMA Cross", overlay=false)
...
short_sig_m    = crossunder(ADX_ema, ADX_ema2) and trend_neg
sell_sig_m     = crossunder(ADX_ema, ADX_ema2)
cover_sig_m    = crossover(ADX_ema, ADX_ema2)
if use_stops
