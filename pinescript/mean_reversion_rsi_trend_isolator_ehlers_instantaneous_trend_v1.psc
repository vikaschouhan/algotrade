//@version=4
strategy(title="Mean Reversion - RSI Trend isolator v1 - Ehlers Instantaneous Trend", overlay=false)
...
//////////////////////////////////////////////////////
// Position signals
buy     = crossover(ind_rsi, rsi_lbnd)
sell    = crossunder(close, stop_l[1]) or crossover(ind_rsi, rsi_hbnd) or crossunder(ind_rsi, rsi_lbnd)
short   = crossunder(ind_rsi, rsi_hbnd)
cover   = crossover(close, stop_s[1]) or crossunder(ind_rsi, rsi_lbnd) or crossover(ind_rsi, rsi_hbnd)
