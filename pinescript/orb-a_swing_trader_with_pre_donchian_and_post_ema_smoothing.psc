//@version=4
strategy(title="ORB-A swingtrader with Donchian and EMA as smoothing signals v2", overlay=true)
...
high_rangeL = ema(security(syminfo.tickerid, time_frame, highest(high_range, donch_len)), ema_len)
low_rangeL  = ema(security(syminfo.tickerid, time_frame, lowest(low_range, donch_len)), ema_len)
