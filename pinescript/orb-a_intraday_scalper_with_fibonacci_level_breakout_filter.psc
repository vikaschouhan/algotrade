//@version=4
strategy(title="ORB-A intraday scalping with fibonacci level breakout filter", overlay=true)
...
level_type     = input('r1-s1', title='Level type', type=input.string, options=['r1-s1', 'r2-s2', 'r3-s3', 'h-l'])
...
[p_level, r1_level, s1_level, r2_level, s2_level, r3_level, s3_level, prev_high, prev_low] = pivot_fib(time_frame)
