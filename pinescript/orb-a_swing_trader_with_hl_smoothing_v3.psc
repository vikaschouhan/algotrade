//@version=4
strategy(title="ORB-A swing with HL smoothing v2", overlay=true)
...
high_rangeL = security(syminfo.tickerid, time_frame, ema(high_range, ema_len)[1])
low_rangeL  = security(syminfo.tickerid, time_frame, ema(low_range, ema_len)[1])
